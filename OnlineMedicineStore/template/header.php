...
<html lang="en">
  ...
  <body style="background-color: #d8f2f2;">
    ...
    <?php
      ...
      {
    ?>
    <div class="jumbotron" style="  background: url('bootstrap/img/dashboard.jpg') no-repeat center center;background-size: cover;height:700px;" >
    <style>
      mark
      {   
    ...
    <!-- <div class="container">>
      <br><br>
        <h1 style="text-align:center; margin:6% auto; color: white; font-style: display; font-size:100px; margin-top: -50px;"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="background-color: blue; padding: 10px;">MED4ALL</b></h1><br><br>
        <h2 style="text-align:center; color: white; margin-top: -50px; font-family: 'Courier New', monospace;"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="background-color: blue; padding: 10px;"> A pharmacy your family can trust</b></h2>
